...
function CloseTrades() {
  ...
  return (
    <div
      className={`trade_list close_trades ${
                ...
                >
                  <div className="top c_flex">
                    ...
                    <div className="right a_flex">
                      <div className="active_type ended">
                        <small>Ended</small>
                  ...
                  <div className="bottom ">
                    ...
                    <div className="span_bottom c_flex">
                      ...
                      <small className="text green">2.5</small>
                    </div> */}
                      <div className="trade_share a_flex">
                        <small className="label">Trade Share</small>
                      ...
                      <div className="stake_status a_flex">
                        <small className="label">Stake Status</small>
                        <small className="text unpaid">unpaid</small>
                        {/* <small className="text red">Loss</small>
                      <small className="text green">Paid</small> */}
                      </div>
                    </div>
                  </div>
                </div>
